...
<!-- button lanjutkan -->
<p class="mb-5 text-lg font-semibold text-gray-500 lg:text-xl text-center dark:text-gray-400">STEP 2</p>
<button id="button-lanjutkan" type="button" class="mb-5 hidden flex mx-auto text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-6 py-2.5 text-center mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    <a href="<?= base_url('konten') ?>">
        Lanjutkan
    </a>
</button>
<h1 class="mb-20 text-4xl font-extrabold tracking-tight leading-none text-center text-gray-900 md:text-3xl lg:text-3xl dark:text-white">Konten</h1>

<!-- main content -->
<div class="grid grid-cols-2 md:grid-cols-2 gap-4 text-center mb-20" style="justify-items:center;">

    <div class="max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="rounded-t-lg" src="<?= base_url('assets/img/product/punyakonten2.jpg') ?> " alt="" />
        </a>
        <div class="p-5">
            <a href="#">
    ...
    <div class="max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="rounded-t-lg" src="<?= base_url('assets/img/product/tidakpunyakonten.jpg') ?>" alt="" />
        </a>
        <div class="p-5">
            <a href="#">
...
<div class="flex text-center flex-col">
    ...
    <p class="font-normal text-gray-700 dark:text-gray-400 italic">*Anda bisa mengkonfigurasi website nanti setelah proses order selesai.</p>
</div>
