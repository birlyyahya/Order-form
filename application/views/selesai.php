...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <div class="p-5 col-span-2 flex flex-col">
        ...
        <!-- tab content -->
        <div class="bg-blue-500 dark:bg-blue-800 border border-gray-200 dark:border-gray-700 rounded-t-lg p-8 md:p-8 shadow-sm">
            <div id="myTabContent">
                <div class="bg-blue-500 p-4 rounded-lg dark:bg-blue-800" id="daftardomain" role="tabpanel" aria-labelledby="daftardomain-tab">
                ...
                <div class="bg-blue-500 p-4 rounded-lg dark:bg-blue-800 hidden" id="transferdomain" role="tabpanel" aria-labelledby="transferdomain-tab">
                    ...
                    <div class="relative">
                        ...
                        <form action="">
                            <input type="search" id="default-search-2" class="default-search block w-full p-5 pl-12 text-sm text-gray-900 border border-gray-300 rounded-lg bg-blue focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Temukan nama domain baru Anda..." required>
                            <button id="btn-daftar-domain-2" aria-labelledby="transferdomain-tab" type="submit" class="btn-daftar-domain text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-12 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cari</button>
                        </form>
                    </div>
                </div>
                <div class="bg-blue-500 p-4 rounded-lg dark:bg-blue-800 hidden" id="hostingsaja" role="tabpanel" aria-labelledby="hostingsaja-tab">
                    ...
                    <div class="relative">
                        ...
                        <form action="">
                            <input type="search" id="default-search-3" class="default-search block w-full p-5 pl-12 text-sm text-gray-900 border border-gray-300 rounded-lg bg-blue focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Temukan nama domain baru Anda..." required>
                            <button id="btn-daftar-domain-3" aria-labelledby="hostingsaja-tab" type="submit" class="btn-daftar-domain text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-12 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Gunakan</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <!-- loading result -->
        <div id="loading-domain" class="hidden bg-white dark:bg-blue-800 border border-gray-200 dark:border-gray-700 rounded-b-lg p-8 md:p-8 shadow-sm relative">
        ...
        <div id="result-domain" class="hidden bg-white dark:bg-blue-800 border border-gray-200 dark:border-gray-700 rounded-b-lg p-8 md:p-8 shadow-sm relative">
            <div class="absolute -top-3 transform -translate-x-1/2 rotate-45 w-5 h-5 bg-white"></div>
            <div class="grid grid-col-1 md:flex flex-wrap items-center text-center justify-center md:text-left">
                ...
                <h2 class=" mb-6 md:mb-0 text-2xl font-bold leading-none tracking-tight text-gray-800 md:text-xl dark:text-white"></h2>
        ...
        <div id="result-domain-nonvalid" class="hidden bg-white dark:bg-blue-800 border border-gray-200 dark:border-gray-700 rounded-b-lg p-8 md:p-8 mb-8 shadow-sm relative">
            <div class="absolute -top-3 transform -translate-x-1/2 rotate-45 w-5 h-5 bg-white"></div>
            <div class="grid grid-col-1 md:flex flex-wrap items-center text-center justify-center md:text-left">
        ...
        <h1 class="mt-20 text-4xl font-thin tracking-tight leading-none text-gray-900 md:text-3xl lg:text-3xl dark:text-white">Billing Account</h1>
        <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white" class="mt-5">
            <h2 id="accordion-color-heading-1">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-800 border border-b-0 border-gray-200 rounded-t-sm focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800">
                    <input checked id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" data-accordion-target="#accordion-color-body-1" aria-expanded="true" aria-controls="accordion-color-body-1" aria-hidden="true">
                    <?php
                    if (!empty($data)) {
                    ?>
            ...
            <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900 p-8">
                    <?php
            ...
            <h2 id="accordion-color-heading-2">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-800 border border-t-0 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800">
                    <input id="default-radio-2" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" data-accordion-target="#accordion-color-body-2" aria-expanded="false" aria-controls="accordion-color-body-2">
                    ...
                    <form class="p-3">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input id="namaDepan" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>

                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="namaBelakang">Nama Belakang</label>
                                <input id="namaBelakang" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>

                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="emailRegister">Email Valid</label>
                                <input id="emailRegister" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>

                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="nomoWA">Nomor Whatsapp</label>
                                <input id="nomorWA" type="number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input id="namaPerusahaan" type="text" class="block w-full py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="negara">Negara</label>
                                <select id="negara" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            ...
                            <div>
                                ...
                                <input id="alamatLengkap" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <div class="flex flex-row" style="justify-content: space-between;">
                                ...
                                <input id="alamatLengkap2" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-5">
                            <div class="col-span-2">
                                <label class="text-gray-600 dark:text-gray-200" for="kota">Kota</label>
                                <input id="kota" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div class="col-span-2">
                                <label class="text-gray-600 dark:text-gray-200" for="provinsi">Provinsi</label>
                                <input id="provinsi" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="kodepos">Kode POS</label>
                                <input id="kodepos" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <select id="survey" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                    <option value=""></option>
                            ...
                            <div>
                                ...
                                <select id="akuninfo" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                    <option value=""></option>
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input id="passwordRegister1" type="password" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <label class="text-gray-600 dark:text-gray-200" for="passwordRegister2">Konfirmasi Kata Sandi</label>
                                <input id="passwordRegister2" type="password" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                        </div>
                    </form>
                </div>
